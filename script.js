...
$( document ).ready(function() {
    ...
    for (let i = 9; i < 18; i++) {
        ...
        //creating column 2
        var col2 = $(`<div class="col-sm-8 past"><textarea id=text${i} class="description" placeholder="Schedule your meeting/event here."></textarea>`);        
        ...
        // adding the rows to the container
